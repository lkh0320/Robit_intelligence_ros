#ifndef DAY4_HW1__IMU_WATCHDOG_HPP_
#define DAY4_HW1__IMU_WATCHDOG_HPP_
...
private:
  ...
  void on_state_timer(); //fake_imu 상태 요청만 보내고 바로 반환
  void on_sensor_state(rclcpp::Client<GetState>::SharedFuture future); //도착한 상태 응답 처리
  ...
  bool state_request_pending_{false}; //이전 상태 요청의 응답을 아직 기다리는지
