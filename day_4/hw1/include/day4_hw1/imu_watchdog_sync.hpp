#ifndef DAY4_HW1__IMU_WATCHDOG_SYNC_HPP_
#define DAY4_HW1__IMU_WATCHDOG_SYNC_HPP_
...
class ImuWatchdogSync : public rclcpp_lifecycle::LifecycleNode
{
public:
  explicit ImuWatchdogSync(const rclcpp::NodeOptions & options = rclcpp::NodeOptions()); //파라미터 선언만
...
private:
  ...
  void on_state_timer(); //콜백 안에서 응답을 기다리는 잘못된 방식
